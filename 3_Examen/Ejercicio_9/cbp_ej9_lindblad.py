...
input_dir = "out_lindblad"
output_dir = "plots_lindblad"
...
for i in range(3):     # Bucle para filas (Estados Iniciales)
    for j in range(3): # Bucle para columnas (Valores de Gamma)
        ...
        file_path = os.path.join(input_dir, f"cbp_ej9_lindblad_{file_id}.dat")
...
plt.tight_layout()
grid_out = os.path.join(output_dir, "grid_evolucion_temporal_lindblad.pdf")
...
for i in range(3):
    ...
    fig_3d_out = os.path.join(output_dir, f"bloch_3d_gamma_lindblad_{g_idx}.pdf")
